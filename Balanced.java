 ...
 * Modified Balanced class and test method.
 * We put the variable currChar and currCharIndex outside of the function then we can use them in BalancedCLI.
 */
...
public class Balanced 
{
  ...
  protected String closeSet;
    public char currChar;                   // current expression character being studied
    public int  currCharIndex;              // index of current character
